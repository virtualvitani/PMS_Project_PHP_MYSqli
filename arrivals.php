...
<html lang="en">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
            <a href="/PMS_Project_PHP_MYSqli/index.php" class="nav-link" aria-current="page"><i class="bi bi-house me-2"></i>Home</a>
        </li>
        <li class="nav-item">
            <a href="/PMS_Project_PHP_MYSqli/arrivals.php" class="nav-link active" aria-current="page"><i class="bi bi-people me-2"></i></i>Arrivals</a>
        </li>
    </ul>
